        ...
        <div className="body-landing flex min-h-screen">
            <div className="sidebar min-h-screen bg-[#12376A] text-white w-[25rem] px-[20px]">
                ...
                <div className="button-area flex flex-col justify-center mt-[60px] gap-[20px]">
                    <div className="button-1 flex flex-row items-center gap-[30px] px-[20px] py-[15px] hover:bg-[#C8732B] hover:rounded-2xl hover:cursor-pointer ">
            ...
            <div className="main-board min-h-screen bg-[#F2F4F3] flex flex-col w-full text-black px-[16px]">
                ...
                <div className="container flex flex-col items-center gap-[20px] mt-[10px]">
                    {/* Kotak informasi */}
                    <div className="box flex flex-row gap-[120px]">
                        <div className="box-1 bg-white w-[300px] p-[20px] rounded-2xl shadow-md flex flex-row items-center gap-[10px] px-[20px] py-[20px]">
                        ...
                        <div className="box-2 bg-white w-[300px] p-[20px] rounded-2xl shadow-md flex flex-row items-center gap-[10px] px-[20px] py-[20px]">
                    ...
                    <div className="form-container bg-white w-[1180px] p-[20px] rounded-2xl shadow-xl">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-[15px]">
                            ...
                            <button
                                type="submit"
                                className="bg-[#12376A] text-white py-[10px] px-[20px] rounded-md hover:bg-[#C8732B]"
                            >
                                Save
                            </button>
                        </form>
